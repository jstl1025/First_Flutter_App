  ...
  void _getStaticMap(String address,
    ...
    if (geocode) {
      final Uri uri = Uri.https(
        ...
        {'address': address, 'key': 'AIzaSyC65WO5PPATtr9lINgzZ6kvIptKy9Q9FU8'},
      );
    ...
    if (mounted) {
      final StaticMapProvider staticMapProvider =
          StaticMapProvider('AIzaSyC65WO5PPATtr9lINgzZ6kvIptKy9Q9FU8');

      final Uri staticMapUri = staticMapProvider.getStaticUriWithMarkers([
        Marker('position', 'Postion', _locationData.latitude,
  ...
  Future<String> _getAddress(double lat, double lng) async {
    final Uri uri = Uri.https(
      ...
      '/maps/api/geocode/json',
      {
        ...
        'key': 'AIzaSyC65WO5PPATtr9lINgzZ6kvIptKy9Q9FU8'
      },
    );
    final http.Response response = await http.get(uri);
    final decodedResponse = json.decode(response.body);
      ...
      children: <Widget>[
        EnsureVisibleWhenFocused(
          ...
          child: TextFormField(
            ...
            validator: (String vallue) {
              if (_locationData == null || vallue.isEmpty) {

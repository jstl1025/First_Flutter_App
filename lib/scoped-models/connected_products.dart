...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<Map<String, dynamic>> uploadImage(File image,
    ...
    final imageUploadRequest = http.MultipartRequest(
        'POST',
        Uri.parse(
            'https://us-central1-flutter-products.cloudfunctions.net/stroeImage'));
  ...
  Future<bool> addProduct(String title, String description, File image,
    ...
    try {
      final http.Response response = await http.post(
          'https://flutter-products-be05d.firebaseio.com/products.json?auth=${_authenticatedUser.token}',
  ...
  void toggleProductFavoriteStatus() async {
    ...
    if (newFavoriteStatus) {
      response = await http.put(
          'https://flutter-products-be05d.firebaseio.com/products/${selectedProduct.id}/wishlistUsers/${_authenticatedUser.id}.json?auth=${_authenticatedUser.token}',
  ...
  Future<Map<String, dynamic>> authenticate(String email, String password,
    ...
    if (mode == AuthMode.Login) {
      response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyA9i1o1WWSmJwRwOegSSPu9WGpMqBLFnmY',
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'});
    } else {
      response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyA9i1o1WWSmJwRwOegSSPu9WGpMqBLFnmY',
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'});
    }
